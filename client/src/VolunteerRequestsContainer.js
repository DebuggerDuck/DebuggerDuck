...
class VolunteerRequestContainer extends Component {
  ...
  render() {
    ...
    let filteredVolunteers = this.state.volunteers.filter(volunteer => 
      volunteer.group_id === this.props.getIdFromGroupName(this.props.currentGroup)
    );
    ...
    if (filteredVolunteers.length===0){
      return(
        <div> 
          ...
          <div className='center'>
            <button className='red-button new-group' onClick={this.props.selectDifferentGroup}>Select a different group</button>
          </div>
        </div>
        )
    } else {
     ...
     <div className='request-container'>
        ...
        <div className='center'>
          <button className='red-button new-group' onClick={this.props.selectDifferentGroup}>
